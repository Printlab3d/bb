...
// DANE TYMCZASOWE (Żeby strona działała bez bazy danych)
const PRODUCTS = [
  {
    id: 1,
    name: "Uchwyt na kask 'Skull'",
    price: 89.00,
    image_url: "/assets/skull-holder.jpg", // Upewnij się, że masz te zdjęcia lub zmień ścieżki
    featured: true,
    stock: 10
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {[
              ...
              { icon: "🛡️", title: "Homologacja", desc: "Certyfikowane" }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
