  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose max-w-none text-gray-700 space-y-6">
        ...
        <p>
          5. <strong>Wyjątki:</strong> Prawo do zwrotu nie przysługuje w przypadku produktów personalizowanych (np. breloki z własnym napisem) oraz wykonanych na indywidualne zamówienie.
        </p>
        ...
        <div className="bg-gray-50 border-l-4 border-gray-800 p-4 my-8">
            ...
            <p>
              4. Nazwa "VibeRush" oraz logo "VR" są znakami handlowymi Sprzedawcy. Ich wykorzystywanie, kopiowanie i rozpowszechnianie bez zgody właściciela jest zabronione i stanowi naruszenie praw autorskich.
            </p>
        </div>
      </div>
    </div>
